...
class AdaboostClassifier(object):
    def __init__(self, max_iter=100, numSteps=500, num_iter=100):
    ...
    def _buildStump(self, X, y, D):
        ...
        for i in range(n):  # 遍历所有的维数
            ...
            print("______in i:%d, minVal:%.6f, maxVal:%.6f, max-min:%.6f"%(i,minVal,maxVal,(maxVal-minVal)))
